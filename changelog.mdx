...
<Info>ollim-bot has been in active development since February 9, 2026 with 340 commits across 18 active development days.</Info>
...
- **BgForkConfig** — new `update_main_session` (modes: `always`,
  `on_ping`, `freely`, `blocked`) and `allow_ping` fields for routines
  and reminders
