...
- **A Claude subscription** — Pro (20 USD/month) or Max (100 USD/month) at [Claude](https://claude.ai). Pro works fine to start; see [model providers](/self-hosting/model-providers) for alternatives
