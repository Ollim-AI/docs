...
<Steps>
  ...
  <Step titleSize="h3" title="Configure the bot">
    ...
    <Tip>
    These three env vars are all you need to get started. On first launch, the bot's welcome message includes a **"Get started — 3 questions"** button that walks you through personality and user context interactively. You can also run `/setup` anytime.
    </Tip>
  </Step>
