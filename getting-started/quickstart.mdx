...
<Steps>
  <Step titleSize="h3" title="Install Git and uv">
    ...
    <Tip>
    Prefer to inspect the script first? Download it, review it, then run it:
  ...
  <Step titleSize="h3" title="Configure the bot">
    ...
    Save the file and close the editor. Then restrict the file permissions
  ...
  <Step titleSize="h3" title="Start the bot">
    ...
    If this is your first time using a Claude subscription, the bot
    sends you a Discord DM with a sign-in link. Open the link and log
