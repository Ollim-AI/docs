...
- **A Claude subscription** (Pro or Max) — [subscribe at claude.ai](https://claude.ai) if you don't have one; see [model providers](/self-hosting/model-providers) for alternatives
...
<Steps>
  ...
  <Step title="Create a Discord bot">
    <Tip>
    First time creating a Discord bot? See [Discord bot setup](/self-hosting/discord-bot-setup) for a walkthrough with screenshots.
    </Tip>

    1. Go to the [Discord Developer Portal](https://discord.com/developers/applications) and click **New Application**
    2. In the left sidebar, click **Bot**
    3. Click **Reset Token** (or **Add Bot** if you see that instead), then copy the token — save it somewhere safe, you'll need it in the next step
    4. Scroll down to **Privileged Gateway Intents** and enable **Message Content Intent** (this lets the bot read your messages)
  ...
  <Step title="Install to your Discord account">
    Back in the [Discord Developer Portal](https://discord.com/developers/applications), click your application, then:

    1. Click **Installation** in the left sidebar
    2. Under **Installation Contexts**, check **User Install** and uncheck **Guild Install**
    3. Set the install link to **Discord Provided Link**
    4. Under **Default Install Settings**, click the scopes dropdown and add `applications.commands`
    5. Click **Save Changes** at the bottom
    6. Copy the **Install Link** and open it in your browser — click **Add to my apps**
    7. Go back to **Bot** in the left sidebar and uncheck **Public Bot** (the bot is personal — only you need it)

    <Warning>
    You must set the install link (steps 3–6) *before* unchecking
    **Public Bot** (step 7). Discord does not allow private apps to have
    an install link, so doing these out of order causes an error.
    </Warning>
  </Step>
