...
<Steps>
  ...
  <Step titleSize="h3" title="Configure the bot">
    ...
    <Tip>
    These three env vars are all you need to get started. After the bot is running, try `/setup` in Discord for a guided walkthrough that configures personality and user context interactively.
    </Tip>
  </Step>
