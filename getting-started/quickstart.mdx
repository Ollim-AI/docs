...
<Steps>
  <Step title="Install Git and uv">
    ...
    **Install uv:**
    ...
    After uv installs, **close your terminal**. You'll open a new one
    later — first, let's set up Discord while the install takes effect.
  </Step>
  ...
  <Step title="Create a Discord bot">
    ...
    **Add Bot** if you see that instead) and copy the token that
    appears — save it somewhere safe, you'll need it soon.
  ...
  <Step title="Install to your Discord account">
    Still in the Discord Developer Portal, click **Installation** in
    the left sidebar.
  ...
  <Step title="Download and install ollim-bot">
    Open a new terminal (same way as [before](#open-a-terminal)). The
    uv command you installed in step 1 is now available.
    ...
    "command not found", close the terminal, open a new one, and try
    again.
  ...
  <Step title="Configure the bot">
    Create the configuration file (still in the same terminal):
