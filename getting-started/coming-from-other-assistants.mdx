...
<AccordionGroup>
  ...
  <Accordion title="Add new integrations">
    ...
    through the Claude Agent SDK — but the [permission system](/core-usage/permissions)
    denies unapproved tools by default. New integrations (Google services, webhook
