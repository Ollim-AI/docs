...
| **Shell access** | Direct host access by default (sandboxing optional) | Available through the Agent SDK, [permission-gated](/core-usage/permissions) per session |
| **Web browsing** | Built-in | Available through the Agent SDK (`WebSearch`, `WebFetch`), [permission-gated](/core-usage/permissions) |
