...
<Steps>
  <Step title="Fork the repository">
    ...
    is a global CLI tool used by [subagents](/extending/subagents) to review
...
You can switch to an Anthropic API key, Amazon Bedrock, Google Vertex AI,
or a custom backend. See [Model providers](/self-hosting/model-providers)
