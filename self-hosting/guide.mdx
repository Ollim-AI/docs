...
<Steps>
  ...
  <Step title="Run the bot">
    ...
    authentication. If not logged in, the bot DMs you an OAuth link — click
    it to sign in with your Anthropic account. This headless flow means you
    never need a browser on the host machine.
...
<Warning>
  ...
  once before enabling the service to avoid this.
</Warning>
