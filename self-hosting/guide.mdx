...
You can modify these prompts by placing override files in
`~/.ollim-bot/subagents/`, or add new subagents by creating additional
spec files in `src/ollim_bot/subagents/`.
