...
| Condition | Status |
|-----------|--------|
| Bad or missing Bearer token | `401 Unauthorized` |
| Unknown webhook slug | `404 Not Found` |
| Invalid JSON body | `400 Bad Request` |
| Schema validation failure | `400` with error details |
...
<AccordionGroup>
  <Accordion title="Request processing pipeline">
    ...
    5. **202 Accepted** — response sent immediately.
    6. **Haiku screening** — free-form string fields are screened for
    ...
    7. **Prompt construction** — payload data fills the template. The
       ...
       instructions.
    8. **Dispatch** — a background fork runs with the spec's
       configuration.
  </Accordion>
