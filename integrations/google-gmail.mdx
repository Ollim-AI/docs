...
- Completed the initial OAuth consent flow — the `gmail.readonly` scope is included by default

## Setup

No additional setup is required beyond the shared Google OAuth flow. The
`https://www.googleapis.com/auth/gmail.readonly` scope is part of the default scope
