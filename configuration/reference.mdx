...
[auto-recovery](/self-hosting/google-oauth-setup#auto-recovery).

See [Google integration setup](/getting-started/google-integration) for the full credential setup process.
