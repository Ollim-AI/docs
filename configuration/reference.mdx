...
settings configured via the [`/config`](/core-usage/slash-commands#config)
slash command. These settings are stored in
`~/.ollim-bot/state/config.json` and survive bot restarts.
