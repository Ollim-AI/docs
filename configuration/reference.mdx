...
at the project root. All persistent data lives in `~/.ollim-bot/`. If you
[initialize it as a git repository](/getting-started/setup#explore-the-data-directory),
...
| `thinking.max_tokens` | integer | `10000` | Token budget when thinking is enabled (field name: `max_thinking_tokens`) |
| `bg_fork_timeout` | integer | `1800` | Max background fork runtime (seconds) |
| `fork_idle_timeout` | integer | `10` | Interactive fork idle timeout (minutes) |
