...
The markdown body contains the skill's instructions. It can include dynamic context markers using the `` !`command` `` syntax — shell commands the SDK expands to their stdout at load time.
