...
- **You asked the bot in a fork** — the fork sends an update to the
  ...
  them too.
- **You edited the file yourself** — changes take effect after
  `/restart`, `/clear`, or the next time the bot starts up. The bot
  doesn't watch the file for changes mid-session.
