...
ollim-bot registers nine slash commands in Discord. All commands are scoped to DMs with the bot.
...
- Resets [permissions](/core-usage/permissions) to default
- Exits any active [interactive fork](/core-usage/forks)
...
Views or configures the [ping budget](/scheduling/ping-budget) — a token-bucket
