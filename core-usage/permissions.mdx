...
All permission modes are **fork-scoped** — changing the mode inside an
interactive fork leaves the main session unchanged. The original mode is
restored when you exit the fork.
