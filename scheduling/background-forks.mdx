...
your main conversation. Routines with `background: true` and all reminders
(which default to background) execute this way — the agent does its work, optionally pings you or reports
