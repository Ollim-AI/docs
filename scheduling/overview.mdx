...
chainable nudges) that fire automatically. Each scheduled
...
<Tabs>
  ...
  <Tab title="Background">
    ...
    Most background sessions are disposable, but routines can opt into
    [persistent sessions](/scheduling/routines#persistent-sessions) that
    accumulate context across fires.
