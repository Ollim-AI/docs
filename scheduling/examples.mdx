...
**Key patterns:**
- **`isolated: true`** — fresh context since this routine doesn't need
  conversation history
- **`model: "haiku"`** — uses the cheapest model since this is simple
  file maintenance (requires `isolated: true` to take effect)
...
schedule the next step, or end the chain by not calling it.
