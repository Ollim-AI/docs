...
| Task capture | 17-24 | When and how to capture tasks |
| Output budget | 26-31 | Guidance on one-thing-at-a-time and lists |
| Configuration notes | 32-48 | CLI invocation style, tool whitelisting, prompt tags |
| Google Tasks | 52-67 | Commands, conventions |
| Google Calendar | 69-84 | Commands, timezone |
| Routines and Reminders | 86-113 | YAML frontmatter spec, CLI commands, chain follow-ups |
