...
ollim-bot has seven extensibility mechanisms: routines, reminders, webhooks, skills, MCP tools, subagents, and interactive forks. Each serves a different trigger pattern and interaction model, but the scheduling mechanisms share a common execution path and configuration schema.
