---
title: "Discord tools"
description: "Reference all eleven Discord tools the agent uses for embeds, pings, forks, reminders, and chains."
---

ollim-bot gives the agent eleven Discord tools for sending messages, managing forks, reporting findings, scheduling reminders, and scheduling follow-ups — all without direct access to the Discord API.
