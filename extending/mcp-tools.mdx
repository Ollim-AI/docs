---
title: "Discord tools"
description: "Reference all eight Discord tools the agent uses for embeds, pings, forks, and chains."
---

ollim-bot gives the agent eight Discord tools for sending messages, managing forks, reporting findings, and scheduling follow-ups — all without direct access to the Discord API.
