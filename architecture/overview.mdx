...
The codebase has 36 modules organized into five layers.

<Accordion title="Full module map (36 modules)">
...
| `agent_context.py` | Message context helpers — timestamps, duration formatting, pending update assembly, ThinkingConfig |
