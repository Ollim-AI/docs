...
| `subagents.py` | Loads subagent specs from `subagents/` with data-dir overrides |
...
| `tool_policy.py` | Tool restriction enforcement for background forks, subagents, and skills |
